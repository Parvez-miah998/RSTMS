...
?> 
        ...
        <div class="button" style="margin-top: 10px;padding: 0px;">
            <button type="submit" style="margin-left: 48%;margin-top: 0px; padding: 10px; border-radius: 20px;background: #57ded7;font-size: 18px;border: none;"><a href="allfood.php" style="text-decoration: none;font-weight: bolder;">See All</a></button>
        </div>
        ...
        <!--Script for control the quantity message end-->
        <!--Script for control the search form start-->
        <script>
document.getElementById("searchForm").addEventListener("submit", function(event) {
    ...
    if (searchInput === "") {
        ...
        <!--Script for control the search form end-->
