		...
		<div class="table">
			<div class="btable">
				<table class="table-data">
                    ...
                    $sql = "SELECT * FROM tbl_bookedtable WHERE t_status = 'Cancel' ORDER BY t_id DESC LIMIT $rowsPerPage OFFSET $offset";
                    	...
                    	$sqlCount = "SELECT COUNT(*) AS total FROM tbl_bookedtable WHERE t_status = 'Cancel'";
